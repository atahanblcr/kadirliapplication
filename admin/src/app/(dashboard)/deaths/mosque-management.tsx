...
import {
  useMosques, useCreateMosque, useUpdateMosque, useDeleteMosque,
  ...
  return (
    <Sheet open={open} onOpenChange={(o) => !o && onClose()}>
      <SheetContent className="w-full sm:max-w-md overflow-y-auto">
        <SheetHeader>
          <SheetTitle>{editing ? 'Cami Düzenle' : 'Yeni Cami Ekle'}</SheetTitle>
        </SheetHeader>

        <form onSubmit={handleSubmit} className="space-y-4 mt-6">
          <div className="space-y-1.5">
            <Label htmlFor="msq-name">Cami Adı *</Label>
            <Input
              id="msq-name"
              placeholder="Ulu Cami"
              value={form.name}
              onChange={set('name')}
            />
          ...
          <div className="space-y-1.5">
            <Label htmlFor="msq-address">Adres</Label>
            <Input
              id="msq-address"
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              <Label htmlFor="msq-lat">Enlem</Label>
              <Input
                id="msq-lat"
                placeholder="37.3667"
                type="number"
            ...
            <div className="space-y-1.5">
              <Label htmlFor="msq-lon">Boylam</Label>
              <Input
                id="msq-lon"
                placeholder="36.1000"
                type="number"
          ...
          <div className="flex items-center justify-between rounded-lg border p-3">
            <Label htmlFor="msq-active" className="cursor-pointer">Aktif</Label>
            <Switch
              id="msq-active"
...
export function MosqueManagement() {
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <p className="text-sm text-muted-foreground">
          Vefat ilanlarında kullanılan camileri yönetin.
        </p>
      ...
      <MosqueForm open={formOpen} onClose={handleCloseForm} editing={editing} />

      <AlertDialog open={!!deleteTarget} onOpenChange={(v) => !v && setDeleteTarget(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Camiyi Sil</AlertDialogTitle>
