...
describe('EventAdminController', () => {
  ...
  beforeEach(async () => {
    ...
    eventAdminService = module.get(EventAdminService);
  });

  describe('getEventCategories', () => {
    it('should return event categories', () => {
      eventAdminService.getEventCategories.mockReturnValue({
        success: true,
        data: [],
      });
  ...
  describe('createEventCategory', () => {
    it('should create event category', () => {
      ...
      eventAdminService.createEventCategory.mockReturnValue({
        success: true,
        data: {},
      });
      controller.createEventCategory(dto);
  ...
  describe('getEvents', () => {
    it('should return events list', () => {
      const dto = {};
      eventAdminService.getAdminEvents.mockReturnValue({
        success: true,
        data: [],
      });
      controller.getEvents(dto);
  ...
  describe('getEvent', () => {
    it('should return event details', () => {
      ...
      eventAdminService.getAdminEvent.mockReturnValue({
        success: true,
        data: {},
      });
  ...
  describe('createEvent', () => {
    it('should create event', () => {
      ...
      eventAdminService.createEvent.mockReturnValue({
        success: true,
        data: {},
      });
      controller.createEvent(dto, userId);
  ...
  describe('updateEvent', () => {
    it('should update event', () => {
      ...
      eventAdminService.updateEvent.mockReturnValue({
        success: true,
        data: {},
      });
      controller.updateEvent(id, dto);
